   ...
   $('#contact-form').on('submit', function (e) {
       ...
       if (!e.isDefaultPrevented()) {
           ...
           $.ajax({
               ...
               {
                   var alertBox = '<div class="alert alert-dismissable text-success"><button type="button" class="close text-danger" data-dismiss="alert" aria-hidden="true">&times;</button> Your Message has been sent </div>';
